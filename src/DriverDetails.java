...
public class DriverDetails extends JFrame {
    ...
    private String drop;
    public DriverDetails(Driver driver,String pickup,String drop) {
        initComponents();
        this.driver = driver;
        this.pickup = pickup;
        this.drop = drop;
        label7.setText(driver.getDriver_name());
        label8.setText(driver.getDriver_phno());
        label9.setText(driver.getRating());
        char x = pickup.charAt(0);
        char y = drop.charAt(0);
        label10.setText(String.valueOf((x-y)*10)+"minutes");
        label11.setText("Rs."+String.valueOf((x-y)*50));
    }
